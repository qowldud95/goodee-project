				...
				<div class="col-lg-8 order-lg-last ftco-animate">
					<div class="row">
						<div class="col-xl-10 ftco-animate">
							...
							<p>
							<a href="/petWalkingUpdate?routeNumber=${route.routeNumber}" class="btn btn-primary py-2 px-3">수정하기</a>
							<a href="/petWalkingDelete?routeNumber=${route.routeNumber}" class="btn btn-primary py-2 px-3">삭제하기</a>
							</p>
						</div>
